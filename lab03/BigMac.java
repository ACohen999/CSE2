...
public class BigMac {
   			  ...
   			  public static void main(String[] args) {
   			      ...
   			      myScanner = new Scanner( System.in ); // construct instance of scanner class declared
   			      System.out.print(
                    "Enter the number of Big Macs(an integer > 0): "); // prompt user for number of Big Macs
